...
### Speaking from a personal level, I absolutely love football. I was blessed to play the game starting at 8 years old and was fortunate enough to play all the way through my junior year of college. This game has brought me joy that very few things in life have been able to match. I was so excited when I was able to find this kind of data publically avaialable and was even more excited to use the great power of machine learning on it! 

> ***The dataset I am using came from Kaggle and it consists of NFL play-by-play data from 2009-2017. My machine learning objective is simple - can I use the data in this dataset to predict if a touchdown will be scored on any given play?***
...
def model_performance(y_true, pred, X_true, clf):
    ...
    """This function will create a confusion matrix and an ROC-AUC plot in order to evaluate model 
    performance.
    ...
    This function will return a confusion matrix, an ROC-AUC visual, the most important features in
    
    model pefromance, and the accuracy for the train and test data."""
